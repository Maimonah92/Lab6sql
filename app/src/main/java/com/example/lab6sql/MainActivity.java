...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setEventListeners();
        setListViewItemClickListener();  // Add this line
    }
    ...
    private void setEventListeners() {
        ...
        dltBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String idStr = pid_textview.getText().toString();
                if (!idStr.equals("Not Assigned")) {
                    int productId = Integer.parseInt(idStr);
                    dbhelper.deleteProduct(productId);

                    pid_textview.setText("Not Assigned");
                    updateDisplayedProducts();
                }
            }
        });
    ...
    private void updateDisplayedProducts(List<ProductModel> products) {
        ArrayAdapter<ProductModel> adapter = new ArrayAdapter<>(this,
    ...
    private void setListViewItemClickListener() {
        products_listview.setOnItemClickListener((parent, view, position, id) -> {
            ...
            pid_textview.setText(String.valueOf(selectedProduct.getProductId()));
        });
    }
}
